...
void ROC3(int pu, int ext)
{
  ...
  //Get HISTOGRAMS
  TH1F *h_SIG_TRG_1 =(TH1F*)f_data1->Get("h_TRG8_variable_roc");
  TH1F *h_SIG_TRG_2 =(TH1F*)f_data1->Get("h_TRG9_variable_roc");
  TH1F *h_SIG_TRG_3 =(TH1F*)f_data1->Get("h_TRG10_variable_roc");

  TH1F *h_BKG_TRG_1 =(TH1F*)f_data2->Get("h_TRG_8_variable_roc");
  TH1F *h_BKG_TRG_2 =(TH1F*)f_data2->Get("h_TRG_9_variable_roc");
  TH1F *h_BKG_TRG_3 =(TH1F*)f_data2->Get("h_TRG_10_variable_roc");
  ...
  leg_1->AddEntry(Graph1,"L1T_2Tk1ME0", "lp");  
  leg_1->AddEntry(Graph2,"L1T_2TkMuStub1ME0", "lp");  
  leg_1->AddEntry(Graph3,"L1T_2TkMu1ME0", "lp"); 
  ...
  char* output;
  if (ext==0)
     output = Form("myplots/ROCcurves/Tau3MuTriggersROC_mixme0_%i.png",pu) ;
  else
     output = Form("myplots/ROCcurves/Tau3MuTriggersROC_mixme0_%i_extended.png",pu) ;
  c_1->SaveAs(output);   
